...
sum_rb=[wind_Result(:,[1,4]);solar_Result(:,[1,6])];  %合并风电、光伏数据
result_rb=hit_rb(sum_rb,input_date);                            %调用汇总函数
strresult_rb=['F:\0\new_ribao\' mydir(end-4:end-1) '.xls'];    %以日期命名保存
...
xlswrite('E:\aa0011\ribao\日报综合数据.xlsx', result_rb);%日报综合数据（6.30）
xlswrite('E:\aa0011\ribao\日报综合数据.xlsx', result_rb);
xlswrite('E:\aa0011\ribao\日报.xlsx', sum_rb, 2);
xlswrite('E:\aa0011\ribao\日报.xlsx', result_rb, 3);
xlswrite('F:\0\new_ribao\日报.xlsx', sum_rb, 2);
xlswrite('F:\0\new_ribao\日报.xlsx', result_rb, 3);
